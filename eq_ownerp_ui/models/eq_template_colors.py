...
class EqTemplateColors(models.TransientModel):
    ...
    SCSS_TEMPLATE = """
        ...
        @if {eq_show_sidebar_names} {{
            ...
            .app-sidebar:hover .eq_sidebar_title {{
            ...
            .app-sidebar .eq_new_icons,
            .app-sidebar .eq_old_icons {{
                width: 34px;
                float: left;
            }}
        }}
        ...
        html .o_web_client > .o_action_manager {{
            margin-left: {app_sidebar_left_margin};
        }}
    ...
    def scss_create_or_update_attachment(self):
        ...
        if eq_show_sidebar:
            app_sidebar = "block"
            app_sidebar_left_margin = "60px"
        else:
            app_sidebar = "none"
            app_sidebar_left_margin = "initial"
        parameters["app_sidebar"] = app_sidebar
        parameters["eq_show_sidebar_names"] = str(parameters["eq_show_sidebar_names"]).lower()
        parameters["app_sidebar_left_margin"] = app_sidebar_left_margin
